...
public class Main {
    ...
    public static void main(String[] args) {
       // System.setProperty("apple.laf.useScreenMenuBar", "true");
        ...
        /**
         * Mise en commentaires des lignes de code qui ne permettent pas le lancement de l'application sous Windows.
         */
        //Application macApp = Application.getApplication();
        //macApp.setAboutHandler(aboutEvent -> JOptionPane.showMessageDialog(app, "Lambda Intrepeter", "About us", JOptionPane.PLAIN_MESSAGE));
